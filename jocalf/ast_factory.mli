...
(** [make_int s] represents an integer whose string representation is
    [s]. The type is not typo: the parser returns a string, not an int. *)
...
(** [make_object \[x1, e1; ...; xn, en\]] represents
    [{x1:e1, ..., xn:en}]. *)
